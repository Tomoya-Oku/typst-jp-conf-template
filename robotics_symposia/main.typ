...
#import "lib.typ": robosym as temp, definition, lemma, theorem, corollary, proof, appendix, sup_ast
...
#show: temp.with(
  ...
  front-matter-order: ("title", "authors", "title-en", "authors-en", "affiliation", "abstract", "keywords"), 
